...
Die Anwendung bietet eine mehrbenutzerfähige Blog-Plattform mit rollenbasierter Zugriffssteuerung, einem komfortablen HTML-Editor für Autoren, verschachtelten Kommentaren und einem responsiven Design.  
...
- Vordefinierte Benutzergruppen: **Author**, **Admin**, **Viewer**.
- Der Benutzer **root** besitzt uneingeschränkte Rechte: Er kann sämtliche Inhalte (Beiträge, Kommentare) bearbeiten und löschen, die Gruppenzugehörigkeit anderer Benutzer verwalten sowie sämtliche administrativen Aufgaben ausführen.

### Blog-Beiträge (Posts)
- Angemeldete Benutzer der Gruppe **Author** können neue Blog-Beiträge verfassen und mit einem komfortablen HTML-Editor formatieren.
...
### Responsives Design
- Die gesamte Benutzeroberfläche passt sich automatisch an verschiedene Geräteklassen an (Desktop-Browser, Tablet, Smartphone), sodass alle Funktionen auf jedem Endgerät gleichermaßen bedienbar sind.

### Administrationsbereich (root)
...
- Für die Verwendung der API werden zeitgemäße Sicherheitsmechanismn verwendet.
...
2. **Beitragserstellung und -bearbeitung**  
   - Rich-Text-Editor (HTML) für Autoren.  
