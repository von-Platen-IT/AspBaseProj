# .NET 10 Fullstack Development Rules (ASP.NET Core, PostgreSQL, EF Core)
...
## 29. Blazor-Readiness
Schreibe Razor/Blazor-Komponenten zustandslos. Lagere UI-State in dedizierte Scoped Services oder URL-Parameter aus. Nutze Code-Behind-Dateien (`.razor.cs` / `.cshtml.cs`) und binde diese an ViewModels oder Use Cases.

## 30. ASP.NET Middleware-Pipeline & Performance
...
## 31. Web-Security (CORS, CSP, Rate Limiting)
...
## 32. Die SPOT-Datei (Single Point of Truth) etablieren
...
## 34. Inhalt und Struktur der SPOT-Datei
...
## 35. ORM-Mapping (EF Core) strikt aus der SPOT ableiten
...
## 36. Konsistenz über alle Schichten
...
## 37. Kontext-übergabe bei Modell-Wechsel oder Pause
...
Wenn du Code generierst, überprüfe ihn stumm gegen diese 37 Regeln. Wenn ein generierter Vorschlag gegen eine Regel verstößt, verwirf ihn und generiere eine konforme Alternative. Kommentiere deine Architekturentscheidungen nur, wenn sie von diesen Standardregeln abweichen.
